...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF1E1B4B);
  late Color tertiary = const Color(0xFF4B5563);
  late Color alternate = const Color(0xFF2D1B4E);
  late Color primaryText = const Color(0xFFF5F5F7);
  late Color secondaryText = const Color(0xFF94A3B8);
  late Color primaryBackground = const Color(0xFF0F0716);
  late Color secondaryBackground = const Color(0xFF1C1226);
  late Color accent1 = const Color(0xFFD8B4FE);
  ...
  late Color hint = const Color(0xFF4B5563);
  late Color divider = const Color(0xFF2D1B4E);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA855F7);
  late Color secondary = const Color(0xFF2E1065);
  late Color tertiary = const Color(0xFF4B5563);
  late Color alternate = const Color(0xFF2D1B4E);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF9CA3AF);
  late Color primaryBackground = const Color(0xFF09040E);
  late Color secondaryBackground = const Color(0xFF160D21);
  late Color accent1 = const Color(0xFFE879F9);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
